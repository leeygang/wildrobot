...
def _parse_reward_weights_config(config: Dict[str, Any]) -> RewardWeightsConfig:
    ...
    return RewardWeightsConfig(
        ...
        propulsion_gate_dense_weight=rewards.get("propulsion_gate_dense_weight", 0.25),
        propulsion_gate_structured_weight=rewards.get("propulsion_gate_structured_weight", 0.75),
        propulsion_gate_dense_cap=rewards.get("propulsion_gate_dense_cap", 0.35),
