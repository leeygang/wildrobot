...
def _parse_env_config(config: Dict[str, Any]) -> EnvConfig:
    ...
    return EnvConfig(
        ...
        reference_motion_npz_path=env.get("reference_motion_npz_path"),
        reference_motion_metadata_path=env.get("reference_motion_metadata_path"),
...
def _parse_reward_weights_config(config: Dict[str, Any]) -> RewardWeightsConfig:
    ...
    return RewardWeightsConfig(
        ...
        teacher_root_pose=rewards.get("teacher_root_pose", 0.0),
        teacher_root_velocity=rewards.get("teacher_root_velocity", 0.0),
        teacher_joint_pose=rewards.get("teacher_joint_pose", 0.0),
        teacher_foot_position=rewards.get("teacher_foot_position", 0.0),
        teacher_contact_timing=rewards.get("teacher_contact_timing", 0.0),
        teacher_phase_consistency=rewards.get("teacher_phase_consistency", 0.0),
        teacher_upright=rewards.get("teacher_upright", 0.0),
        teacher_root_pos_sigma=rewards.get("teacher_root_pos_sigma", 0.08),
        teacher_root_quat_sigma=rewards.get("teacher_root_quat_sigma", 0.15),
        teacher_root_lin_vel_sigma=rewards.get("teacher_root_lin_vel_sigma", 0.25),
        teacher_root_ang_vel_sigma=rewards.get("teacher_root_ang_vel_sigma", 0.30),
        teacher_joint_sigma=rewards.get("teacher_joint_sigma", 0.20),
        teacher_foot_sigma=rewards.get("teacher_foot_sigma", 0.06),
        teacher_phase_sigma=rewards.get("teacher_phase_sigma", 0.10),
        teacher_upright_sigma=rewards.get("teacher_upright_sigma", 0.25),
