...
def _parse_env_config(config: Dict[str, Any]) -> EnvConfig:
    ...
    return EnvConfig(
        ...
        standing_recovery_reset_torso_roll_range=env.get(
            "standing_recovery_reset_torso_roll_range"
        ),
        standing_recovery_reset_torso_pitch_range=env.get(
...
def _parse_ppo_config(config: Dict[str, Any]) -> PPOConfig:
    ...
    return PPOConfig(
        ...
        eval=PPOEvalConfig(
            ...
            post_training_enabled=eval_cfg.get(
                "post_training_enabled",
                eval_cfg.get("promotion_enabled", False),
            ),
            post_training_top_k=eval_cfg.get("post_training_top_k", 3),
            post_training_num_envs=eval_cfg.get(
                "post_training_num_envs",
                eval_cfg.get("promotion_num_envs", 8),
            ),
            post_training_num_steps=eval_cfg.get(
                "post_training_num_steps",
                eval_cfg.get("promotion_num_steps", 500),
            ),
            post_training_checkpoint_label=eval_cfg.get(
