# Training Changelog (Archive)

This file archives historical training-changelog entries.  The active
changelog lives in `CHANGELOG.md` and now carries only smoke13+ work
(the current smoke14 / smoke15 line); smoke12b and earlier v0.20.1
entries plus the full pre-v0.20.1 history are here.

**Ordering:** Newest releases first (reverse chronological order).

**Archive cuts:**

- 2026-05-24: smoke12b + earlier v0.20.1 entries archived into this
  file (the section starting `## [v0.20.1-smoke12b-ot8zazo1-result]`
  below).  The active CHANGELOG now starts at the smoke15 entries
  layered on top of smoke13 / smoke14 work.
- Earlier: all pre-v0.20.1 entries (v0.20.0-C downward) archived.

---

<!-- ========================================================================
 2026-05-24 archive cut — v0.20.1 smoke12b and earlier entries below.
 The section that follows ("v0.20.0-C" and older) is the original
 pre-v0.20.1 archive; the v0.20.1 entries from smoke12b through
 smoke1 / smoke-prep were moved here from CHANGELOG.md.
======================================================================== -->
