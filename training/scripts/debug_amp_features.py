...
robot_config_path = Path("assets/v2/mujoco_robot_config.json")
...
def analyze_reference_data():
    ...
    # Load reference data
    ref_path = Path("training/data/walking_motions_normalized_vel.pkl")
...
def analyze_policy_features():
    ...
    from training.envs.wildrobot_env import EnvConfig, WildRobotEnv
