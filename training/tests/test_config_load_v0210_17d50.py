...
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d50_onset_band_failure_replay.yaml"
)
...
def test_17d50_changes_only_onset_band_replay_bootstrap() -> None:
    ...
    assert cfg.version == "0.21.0-17d50"
    ...
    assert "auto-18-eval-failure_diagnostic-5c2f8179" in bootstrap["failure_trace"]
    assert bootstrap["failure_trace_sha256"] == (
        "9a6bf2ff2a88c097b27bc4715267005cf3907cbb380d0a1b8927d9dd1322a488"
    )
    assert bootstrap["failure_replay_repeats"] == 16
    assert bootstrap["failure_replay_min_pitch_rad"] == pytest.approx(-0.25)
    assert bootstrap["failure_replay_max_pitch_rad"] == pytest.approx(-0.08)
