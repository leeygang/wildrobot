...
CONFIG = Path("training/configs/ppo_walking_v0210_17d46_knee_torque_headroom.yaml")
...
def test_17d46_changes_only_knee_headroom_mask_and_budget() -> None:
    ...
    assert cfg.version == "0.21.0-17d46"
