...
BASE_CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d26_contact_free_home_mix.yaml"
)
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d30_contact_observed_recovery.yaml"
)
...
def _normalized_contract(path: Path) -> dict:
    ...
    raw["env"]["actor_obs_layout_id"] = "<actor-observation-layout>"
    raw["checkpoints"].pop("dir")
    raw["wandb"].pop("tags")
    return raw


def test_17d30_changes_only_actor_observation_contract_and_metadata() -> None:
