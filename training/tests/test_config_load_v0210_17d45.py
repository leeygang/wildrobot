...
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d45_failure_state_replay_retention.yaml"
)
...
def test_17d45_changes_only_replay_bootstrap_and_budget() -> None:
    ...
    assert cfg.version == "0.21.0-17d45"
    ...
    assert bootstrap["student_checkpoint_sha256"] == (
        "04fe7987d9c718dab4f4857002388535052618d1c12c504045a8057291d027df"
    )
    assert "auto-13-eval-failure_diagnostic-2f857095" in bootstrap["failure_trace"]
    assert bootstrap["failure_trace_sha256"] == (
        "ae56213e77394f9e99b2a89a381e02c085795262221126a831f4614a456ee915"
    )
