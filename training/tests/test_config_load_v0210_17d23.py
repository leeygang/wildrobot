...
BASE_CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d22_contact_free_resume.yaml"
)
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d23_contact_free_resume.yaml"
)
...
def test_17d23_preserves_the_complete_17d22_training_contract() -> None:
    ...
    assert cfg.version == "0.21.0-17d23"
