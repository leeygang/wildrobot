...
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d34_contact_free_rollback_guard.yaml"
)
...
def test_17d34_changes_only_rollback_patience_and_metadata() -> None:
    ...
    assert cfg.version == "0.21.0-17d34"
