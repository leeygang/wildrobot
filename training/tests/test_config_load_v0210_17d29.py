...
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d29_contact_free_home_mix_resume.yaml"
)
...
def test_17d29_preserves_the_complete_17d26_training_contract() -> None:
    ...
    assert cfg.version == "0.21.0-17d29"
