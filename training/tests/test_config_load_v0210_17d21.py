...
BASE_CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d20_contact_free_kl_release.yaml"
)
CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d21_contact_free_resume.yaml"
)
...
def test_17d21_preserves_the_complete_17d20_training_contract() -> None:
    ...
    assert cfg.version == "0.21.0-17d21"
    assert cfg.ppo.iterations == 10
    assert cfg.ppo.learning_rate == 2.0e-6
