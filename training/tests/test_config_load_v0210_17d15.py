...
BASE_CONFIG = Path(
    "training/configs/ppo_walking_v0210_17d14_stance_width_retreat.yaml"
)
CONFIG = Path("training/configs/ppo_walking_v0210_17d15_stance_width_retreat.yaml")
