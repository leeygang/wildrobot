...
|------|----------|----------|
| `cal.py` | `training/cal/` | Main ControlAbstractionLayer class with all transformation methods |
| `specs.py` | `training/cal/` | JointSpec, ActuatorSpec, ControlCommand, Pose3D, Velocity3D, FootSpec, RootSpec |
| `types.py` | `training/cal/` | ActuatorType, VelocityProfile, CoordinateFrame enums |
| `__init__.py` | `training/cal/` | Module exports |
| `cal.md` | `training/cal/` | This documentation |
...
├── 1. training/cal/types.py          # Enums (CoordinateFrame, ActuatorType, VelocityProfile)
├── 2. training/cal/specs.py          # Dataclasses (JointSpec, ActuatorSpec, Pose3D, Velocity3D, etc.)
├── 3. training/cal/cal.py            # Main class (ControlAbstractionLayer)
└── 4. training/cal/__init__.py       # Exports
...
Phase 5: Tests
└── 9. training/tests/test_cal.py     # Unit tests
```
