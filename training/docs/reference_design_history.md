# WildRobot Nominal Reference Design History

**Status:** Historical companion to the active `v0.20.x` design note  
**Last updated:** 2026-04-17

---

This file preserves the deprecated runtime-FSM reference lineage, `M2.5`
probe definitions, `v0.19.x` retrospective notes, and the older DCM COM
trajectory milestones.

The active offline-prior architecture and `v0.20.x` milestones now live in
[reference_design.md](reference_design.md).

---

## Historical Reference Evolution

The sections below document the old runtime-FSM lineage (`walking_ref_v1`,
`walking_ref_v2`) and remain valuable as historical context and as possible
offline generator ideas. They are not the active runtime architecture for
`v0.20`.
...
---
## Historical Validation And Probe Notes
...
## Historical Support-First And Dynamically Valid Checklist
