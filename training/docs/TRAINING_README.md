...
### Training Config
`training/configs/wildrobot_phase3_training.yaml`
...
1. **Discriminator**: Initialized from `training/amp/discriminator.py`
...
Reduce `--num-envs`:
```bash
python training/train.py --num-envs 512  # Instead of 2048
```
...
- **Phase 3 Training Plan**: `training/phase3_rl_training_plan.md`
