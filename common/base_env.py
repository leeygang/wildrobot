...
# ==============================================================================
"""Base environment class for WildRobot tasks - shared across all implementations."""
...
class WildRobotEnvBase(mjx_env.MjxEnv):
    """Base class for WildRobot environments - provides robot infrastructure.
