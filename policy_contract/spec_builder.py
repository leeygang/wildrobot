...
def _build_obs_layout(*, action_dim: int, layout_id: str) -> List[ObsFieldSpec]:
    ...
    if layout_id == "wr_obs_teacher":
        return [
            ...
            ObsFieldSpec(name="prev_action", size=action_dim, units="normalized_-1_1"),
            ObsFieldSpec(name="velocity_cmd", size=1, units="m_s"),
            ObsFieldSpec(name="teacher_phase", size=2, units="sin_cos_phase"),
            ObsFieldSpec(name="teacher_joint_pos_target", size=action_dim, units="normalized_-1_1"),
            ObsFieldSpec(name="teacher_root_lin_vel_target", size=2, units="m_s"),
            ObsFieldSpec(name="teacher_root_height_target", size=1, units="m"),
            ObsFieldSpec(name="padding", size=1, units="unused"),
        ]
