# playground_amp/tests/test_schema_contract.py
"""
    ...
    def test_snapshot_consistency(self, project_root, robot_schema):
        ...
        try:
            ...
            pytest.fail(
                ...
                f"If intentional, run: python -c 'from playground_amp.tests.robot_schema import extract_and_save_schema; extract_and_save_schema()'\n"
                f"Details: {e}"
            )
