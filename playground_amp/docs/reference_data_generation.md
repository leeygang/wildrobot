...
This script:
1. Loads `playground_amp/data/walking_motions_merged.pkl` (29-dim)
2. Normalizes indices 18-20 (root_linvel) to unit direction: `v_dir = v / (||v|| + ε)`
3. Saves `playground_amp/data/walking_motions_normalized_vel.pkl` (29-dim)
...
| AMP data | `~/projects/wildrobot/playground_amp/data/` | Training-ready features |
| Training config | `playground_amp/configs/ppo_amass_training.yaml` | Points to dataset |
