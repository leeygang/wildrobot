...
def save_checkpoint_from_cpu(
    ...
    checkpoint_data = {
        ...
        "config": {
            ...
            "amp_reward_weight": config.amp.reward_weight,
            "disc_learning_rate": config.amp.disc_learning_rate,
            "disc_updates_per_iter": config.amp.disc_updates_per_iter,
            "disc_batch_size": config.amp.disc_batch_size,
            "r1_gamma": config.amp.r1_gamma,
            "disc_hidden_dims": config.amp.disc_hidden_dims,
            "disc_input_noise_std": config.amp.disc_input_noise_std,
