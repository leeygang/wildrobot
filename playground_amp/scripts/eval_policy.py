...
Usage:
  uv run python playground_amp/scripts/eval_policy.py --checkpoint <path> --config <yaml>
"""
...
from playground_amp.training.checkpoint import load_checkpoint
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="playground_amp/configs/ppo_standing.yaml",
