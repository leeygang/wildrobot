...
This script analyzes the Tier 0+ dataset generated by generate_tier0plus_segments.py
and computes:
...
def main():
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        default="playground_amp/data/tier0plus/tier0plus_merged.pkl",
    ...
    if not dataset_path.exists():
        ...
        print(f"\nRun generate_tier0plus_segments.py first:")
        print(f"  uv run python scripts/generate_tier0plus_segments.py --verbose")
        sys.exit(1)
